      ...
      $('div[data-sortable]', elem).sortable({
        ...
        update: function(e, ui) {
          ...
          if(item.attr('data-element-type')) {
            console.log('Add new '+item.attr('data-element-type')+' on page "'+$('#hy-body').attr('data-page-id')+'" to parent "'+parent.attr('data-element-id')+'" just after "'+prev.attr('data-element-id')+'" and before "'+next.attr('data-element-id')+'"')
            $.humpyard.dialog(item.attr('data-create-url'), {
              get: {
                type: item.attr('data-element-type'), 
                page_id: $('#hy-body').attr('data-page-id'),
                container_id: parent.attr('data-element-id'),
                prev: prev.attr('data-element-id'),
                next: next.attr('data-element-id')
              }
            });
            item.empty();
            e.preventDefault();
          } else {
            console.log('Drag "'+item.attr('data-element-id')+'" to parent "'+parent.attr('data-element-id')+'" just after "'+prev.attr('data-element-id')+'" and before "'+next.attr('data-element-id')+'"')        
          }
        }
      });
