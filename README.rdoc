...
Humpyard is a CMS in a gem for Rails 3.1
...
== What about Rails 3.0 and Ruby 1.8

As Humpyard is dealing with a lot of assets, it was very welcome that Rails 3.1 introduced the asset pipeline.
So Humpyard versions >= 0.1.0 need Rails 3.1 to run.
Ruby 1.8 support was removed as Rails 3.1 works better with Ruby 1.9.

== Copyright

Copyright (c) 2010-2011 Sven G. Brönstrup. See LICENSE for details.
