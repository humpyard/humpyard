Feature: Page Routing
 ...
 Scenario: Miss Index with custom www prefix with locale
  ...
  Scenario: View Subpage with default www prefix
	Given the configured www prefix is ":default"
  ...
  Scenario: View Imprint with custom allowed locale
	Given the configured locales is "en,de"
	When I go to path "/de/imprint.html"
	Then I should get a status code of 200
	And I should see the page with id 89
	
  Scenario: Miss Imprint with custom disallowed locale
	Given the configured locales is "en,fr"
	When I go to path "/de/imprint.html"
	Then I should get a status code of 404
